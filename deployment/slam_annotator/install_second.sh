...
# Doc: 		Second shell script to setup workspace for use with ROS package access_mapping.
#		Assumes a fresh install of Ubuntu 18.04 and the successful completion of the
#		first install script: install_first.sh. Script was built and tested
...
echo -e "\n# Source the catkin workspace" >> $shell_setup
